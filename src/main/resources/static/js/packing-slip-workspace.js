...
if(new URLSearchParams(location.search).get('sellerCentralBlocked')==='true'){
  ...
  if(status){status.setAttribute('role','status');status.textContent='Chrome blocked the second tab. Click “2 · Seller Central” above to open the order. Allow pop-ups for this site to open both tabs automatically next time.';}
}
