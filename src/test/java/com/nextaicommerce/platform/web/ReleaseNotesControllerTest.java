...
class ReleaseNotesControllerTest {
    @Test void selectsCurrentPreviousAndUnknownReleases() throws Exception {
        ...
        assertThat(((ReleaseNotesController.Release)model.get("release")).version()).isEqualTo("1.3.7");
        ...
        assertThat(engine.process("release-notes",new Context(null,model)))
            .contains("Receiving case-size defaults","v1.3.7","Deployment history","/css/release-notes.css");
        assertThat(controller.history()).extracting(ReleaseNotesController.Release::version)
            .containsExactly("1.3.7","1.3.6","1.3.5","1.3.4","1.3.3","1.3.2","1.3.1","1.3.0","1.2.7","1.2.6","1.2.5","1.2.4","1.2.3","1.2.2","1.2.1","1.2.0","1.1.1","1.1.0","1.0.5","1.0.4","1.0.3","1.0.2","1.0.1","1.0.0");
    }
}
