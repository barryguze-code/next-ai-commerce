...
class ReleaseNotesControllerTest {
    @Test void selectsCurrentPreviousAndUnknownReleases() throws Exception {
        ...
        assertThat(((ReleaseNotesController.Release)model.get("release")).version()).isEqualTo("1.2.1");
        ...
        assertThat(engine.process("release-notes",new Context(null,model)))
            .contains("Receiving closure and inventory pictures","v1.2.1","Deployment history","/css/release-notes.css");
        assertThat(controller.history()).extracting(ReleaseNotesController.Release::version)
            .containsExactly("1.2.1","1.2.0","1.1.1","1.1.0","1.0.5","1.0.4","1.0.3","1.0.2","1.0.1","1.0.0");
    }
}
