...
class PackingSlipTemplateTest {
    @Test void rendersThePrintSizedInternalPackingDetails(){
        ...
        var slip=new PackingSlipRepository.Slip("113-1234567-1234567","https://sellercentral.amazon.com/orders-v3/order/113-1234567-1234567","Ski Queen",
            "UPS OMBox",true,List.of(new PackingSlipRepository.Line("IB-MKH-53383-GJETOST-SKIQUEEN-EA","Cheese Gjetost",1,LocalDate.of(2027,6,17),"MAIN"),
        ...
        assertThat(html)
            .contains("Ski Queen","UPS OMBox","Cheese Gjetost","Second product","Third product","2027-06-17","MAIN","Seller Central","Save package","Print 2 × 1 slip")
            .doesNotContain("No historical package match","Order 113-1234567-1234567","Internal packing only");
